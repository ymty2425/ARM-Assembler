...
enum parse_opcode_enum {OC_CMP, OC_DP, OC_LS, OC_MUL, OC_MEM, OC_B, OC_BX, OC_NONE};
...
#define PARSE_B_OPS {"b", "bl", "beq", "bne", "bgt", "bge", "blt", NULL}
#define PARSE_BX_OPS {"bx", NULL}

enum parse_stmt_enum {INST, SEQ, DIR};
enum parse_inst_enum {CMP, CMPI, DP3, DP3I, DP2, DP2I, LSI, MUL, MEM3, MEMI, B, BX};
    ...
    union {
        ...
        struct {
            ...
            union {
				...
				struct {int rd; int rm; int imm;} lsi;
...
#define CODEGEN_OPCODE_MAP \
    { {"add", 0b0100}, {"sub", 0b0010}, {"mov", 0b1101}, {"cmp", 0b1010}, {"mvn", 0b1111} };
